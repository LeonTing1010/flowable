...
import com.galaxy.flowable.engine.handler.HistTaskQueryHandler;
import com.galaxy.flowable.engine.handler.TaskHandler;
import com.galaxy.flowable.engine.handler.TaskQueryHandler;
import com.galaxy.flowable.repository.model.HistTaskVO;
...
public class QueryController {
  ...
  @Autowired private HistTaskQueryHandler histTaskQueryHandler;
  ...
  public Object pageListByInstanceId(String instanceId, Integer page, Integer step) {
    List<HistoricTaskInstance> list =
        histTaskQueryHandler.pageListByInstanceId(instanceId, page, step);
    return ResponseData.success(list);
  }
  ...
  public Object claimed(String userId) {
    List<HistoricTaskInstance> list =
        historyService.createHistoricTaskInstanceQuery().taskAssignee(userId).list();
    return ResponseData.success(list);
  }
