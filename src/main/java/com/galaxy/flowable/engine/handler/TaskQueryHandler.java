...
import com.galaxy.flowable.engine.ActTaskQuery;
import com.galaxy.flowable.engine.ServiceFactory;
import com.galaxy.flowable.engine.common.VariablesEnum;
...
public class TaskQueryHandler extends ServiceFactory implements ActTaskQuery {
  ...
  @Override
  public List<Task> taskCandidateUserByCondition(
      String candidateUser, Map<String, Object> variables, int start, int limit) {
    return buildTaskQueryByVariables(variables)
        .taskCandidateUser(candidateUser)
        .orderByTaskPriority()
        .desc()
        .orderByTaskCreateTime()
  ...
  @Override
  public List<Task> taskAssigneeByCondition(
      String assignee, Map<String, Object> variables, int start, int limit) {
    return buildTaskQueryByVariables(variables)
        .taskAssignee(assignee)
        .orderByTaskPriority()
        .desc()
  ...
  @Override
  public List<Task> taskCandidateOrAssignedByCondition(
      String userId, Map<String, Object> variables, int start, int limit) {
    return buildTaskQueryByVariables(variables)
        .taskCandidateOrAssigned(userId)
        .orderByTaskPriority()
        .desc()
  ...
  @Override
  public long countTaskCandidateUserByCondition(
      String candidateUser, Map<String, Object> variables) {
    return buildTaskQueryByVariables(variables)
        .taskCandidateUser(candidateUser)
        .orderByTaskPriority()
        .desc()
  ...
  @Override
  public long countTaskCandidateOrAssignedByCondition(
  ...
  @Override
  public List<Task> taskAssigneeByTaskQuery(
      String assignee, TaskQuery query, int start, int limit) {
    return query
        .taskAssignee(assignee)
        .orderByTaskPriority()
        .desc()
